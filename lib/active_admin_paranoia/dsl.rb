module ActiveAdminParanoia
  module DSL
    def active_admin_paranoia
      ...
      member_action :destroy, method: :delete, confirm: proc{ I18n.t('active_admin.batch_actions.delete_confirmation') }, if: proc{ authorized?(ActiveAdmin::Auth::DESTROY, resource_class) && params[:scope] != 'archived' } do
        resource.destroy
